...
def read_cluster_config(clusters_ini_path, datacenter):
    ...
    if 'JOARA_APP_MAIN' not in os.environ and not 'JOARA_APP_MAIN' in config_dict:
        config_dict['JOARA_APP_MAIN'] = find_joara_app_main()
        os.environ['JOARA_APP_MAIN'] = config_dict['JOARA_APP_MAIN']

    if 'JOARA_APP_MAIN' in os.environ:
        config_dict['JOARA_APP_MAIN'] = os.environ.get('JOARA_APP_MAIN')
