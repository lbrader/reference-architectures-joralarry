        ...
        for dc in all_datacenters:
            if dc in kube_datacenters:
                for group in groups:
                   ...
                   logger.info("################### Started Provisioning datacenter: {}, resource: {} ###################".format(dc,args.group))
                  ...
                  logger.warn("################### Please configure jenkins in web ui by following the steps present in the document, on completion please type yes or no ###################")
                  ...
                  if response.lower() == "yes":
                      ...
                      logger.warn("################### Your response is {}, so jenkins configuration not proceeded. ###################".format(response))
                      sys.exit(1)
